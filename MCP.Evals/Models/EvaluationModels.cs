...
/// <summary>
/// Options configuration for MCP Evals system
/// </summary>
public sealed class McpEvalsOptions
{
    public LanguageModelConfiguration DefaultLanguageModel { get; set; } = new LanguageModelConfiguration
    {
        Provider = "openai",
        Name = "gpt-4o",
        MaxTokens = 4000,
